      ...
      <article class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h3 class="text-2xl font-bold text-gray-900">{{ metrics.totalTeams }}</h3>
          </div>
      ...
      <article class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h3 class="text-2xl font-bold text-gray-900">{{ metrics.activeUsers }}</h3>
          </div>
      ...
      <article class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h3 class="text-2xl font-bold text-gray-900">{{ metrics.ongoingTasks }}</h3>
          </div>
      ...
      <article class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h3 class="text-2xl font-bold text-gray-900">{{ metrics.completionRate | number:'1.0-1' }}%</h3>
          </div>
